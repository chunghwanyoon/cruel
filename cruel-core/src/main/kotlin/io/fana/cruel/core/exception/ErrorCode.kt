...
enum class ErrorCode(
    ...
    /* KYC */
    VALIDATION_FAILED(ErrorGroup.KYC, "001", "ERR_VALIDATION_FAILED"),
    PHONE_AUTHENTICATION_NOT_FOUND(
        ErrorGroup.KYC,
        "002",
        "ERR_VALID_PHONE_AUTHENTICATION_NOT_FOUND"
    ),
    PHONE_AUTHENTICATION_ALREADY_EXIST(
        ErrorGroup.KYC,
        "003",
        "ERR_PHONE_AUTHENTICATION_ALREADY_EXIST"
    ),
    PHONE_AUTHENTICATION_VERIFY_FAILED(
        ErrorGroup.KYC,
        "004",
        "ERR_PHONE_AUTHENTICATION_VERIFY_FAILED"
    );
